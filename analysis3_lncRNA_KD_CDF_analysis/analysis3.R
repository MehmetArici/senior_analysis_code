...
datadir = '/var/www/html/analysis_code/datasets/Table5_lncRNA_KD_datasets/'
outdir = '/var/www/html/senior/public/results/analysis3_lncRNA_KD_CDF_analysis/'
setwd('/var/www/html/analysis_code/analysis3_lncRNA_KD_CDF_analysis/')
