...
file_2770 <- "/Volumes/Elements/lncrnas_transfer/lncRNAs_Human/base_data/expression_data/E-MTAB-2770-query-results_removedcomments.tsv"
...
filename = paste('./results/', rbp, '_targets_nontargets_', 'lncRNAdata_', lncRNA, '_E-MTAB-2770' , '.jpeg' , sep= '')
