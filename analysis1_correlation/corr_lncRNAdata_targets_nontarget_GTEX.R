...
file_GTEX <- "/media/DATAPART1/lncRNAs_Human/base_data/expression_data/GTEX/GTEx_depthmatched_onlyENSG.gct"
GTEX_file = read.table(file_GTEX, header = TRUE, row.names=1, check.names=FALSE)
...
for (lncRNA in lncRNA_list){
  ...
  filename = paste('/media/DATAPART1/PUM_analysis/correlation/results/corr_lncRNAdata/', rbp, '_targets_nontargets_', 'lncRNAdata_', lncRNA, '_GTEX' , '.jpeg' , sep= '')
